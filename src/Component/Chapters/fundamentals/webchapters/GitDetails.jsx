...
const GitDetails = () => {
  return (
    <>
      <Websidenav />
      <div className="fixed top-16 md:left-72 md:w-[80%] w-full h-[calc(100vh-4rem)] bg-gray-900 p-6 text-cyan-300 overflow-y-auto pb-72 md:pb-6 text-left space-y-6">
  ...
  <code>
    ...
    <div><span className="text-green-400">$ git log</span> <span className="text-white">– Commit history dekhne ke liye</span></div>
        ...
        <div className="w-full flex items-center justify-between mt-8 px-4">
          ...
          <Link to={"/git/github-vs-git"}>
            <button className="bg-cyan-600 text-white font-semibold px-6 py-3 rounded-xl border-2 border-white hover:bg-cyan-700 hover:scale-105 transition-all duration-300 shadow-md">
              NEXT
            </button>
          </Link>
        </div>
