      ...
      <div className="bg-gradient-to-br from-purple-950 via-black to-gray-900 text-white py-16 px-6 md:px-20 min-h-screen w-full flex flex-col md:flex-row items-center justify-center gap-10">
        ...
        <div className="max-w-2xl text-center md:text-left">
          ...
          <p className="text-lg md:text-xl text-gray-300 leading-relaxed">
            ...
            <strong className="text-purple-400">Rohit Singh</strong> hai. Jaisa
            ki aap jaante hain, maine ye website banayi hai. Aur is website mein
            aapko
            ...
            Maine apna course{" "}
            <strong className="text-purple-400">GeeksforGeeks</strong> se
            complete kiya hai. Ye website maine banayi hai taaki aapki{" "}
            <strong className="text-purple-400">learning easy</strong> ho, Hindi
            + English mix language mein. Ummid karta hoon ki aapko ye website
            pasand aayegi aur
